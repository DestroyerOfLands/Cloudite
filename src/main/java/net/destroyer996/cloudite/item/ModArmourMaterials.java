...
public enum ModArmourMaterials implements ArmorMaterial {
    CLOUDITE("cloudite", 40, new int[]{3, 6, 8, 3}, 25, SoundEvents.ARMOR_EQUIP_NETHERITE, 1f, 1f, ()-> Ingredient.of(ModItems.CLOUDITE_INGOT.get()));
    ...
    public String getName() {
        return Cloudite.MOD_ID + ":" + this.name;
    }
